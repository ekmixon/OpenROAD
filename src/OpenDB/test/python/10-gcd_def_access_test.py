...
assert inst.getHalo() is None, "Instance Halo mismatch"
...
assert master.getLEQ() is None, "Master LEQ"
assert master.getEEQ() is None, "Master EEQ"
...
assert net.getWire() is None, "Net wire mismatch"
assert net.getSWires() == [], "Net Swire mismatch"
assert net.getGlobalWire() is None, "Net global wire mismatch"
